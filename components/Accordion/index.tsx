...
>(({ title, className, children, ...props }, ref) => {
  return (
    ...
    >
      <>
        <AccordionPrimitive.Trigger className="flex w-full items-center gap-1 px-2 py-[1.125rem] text-left transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring data-[state=open]:bg-neutral-100 data-[state=open]:dark:bg-neutral-950">
      ...
      <AccordionPrimitive.Content className="overflow-hidden pr-6 data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
...
function CopyButton({ id }: { id: string }): JSX.Element {
  ...
  return (
    <button
      ...
      className="opacity-0 transition-all hover:bg-accent hover:text-accent-foreground group-data-[state=open]/accordion:opacity-100"
      onClick={onClick}
    >
