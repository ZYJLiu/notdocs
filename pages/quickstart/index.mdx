...
export const links = [
  "https://github.com/solana-developers/anchor-starter/blob/8964eb13b91c865fc930ee68d2de05786b969e23/03-pda-counter-token/programs/counter/src/lib.rs#L1-L175",
  "https://github.com/solana-developers/anchor-starter/blob/8964eb13b91c865fc930ee68d2de05786b969e23/03-pda-counter-token/tests/counter.ts#L3-L110",
];
...
- ok this program won't work on solpg rn, due to dependency diff

<Tabs items={["Iframe", "StackBlitz", "Program", "Test"]}>
  <Tabs.Tab>
    <iframe
